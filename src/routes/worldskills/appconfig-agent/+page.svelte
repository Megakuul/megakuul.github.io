...
<svelte:head>
  <title>AppConfig Agent | Megakuul</title>
  <meta
    name="description"
    content="AppConfig Agent deployment, permissions and usage snippets for Lambda, ECS and EKS."
  />
  <link rel="canonical" href="https://megakuul.ch/worldskills/appconfig-agent" />
</svelte:head>
...
<div class="sticky top-0 z-30 border-b border-white/5 bg-[rgb(17,16,16)]/90 backdrop-blur-md">
  <div class="mx-auto flex max-w-350 items-center gap-3 px-4 py-3">
    ...
    >
    <h1 class="min-w-0 flex-1 truncate text-lg font-bold">AppConfig Agent</h1>
    <button
