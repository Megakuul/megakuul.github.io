...
export const projects: Record<string, Project> = {
  ...
  appsync: {
    title: 'AppSync',
    description: 'JavaScript resolvers, authorization, pipelines and data sources',
    published: '14.09.2026',
    services: ['appsync', 'cognito', 'dynamodb', 'lambda', 'rds', 'events', 'sqs', 'opensearch'],
  },
  ...
  codepipeline: {
    title: 'CodePipeline',
    description: 'Full pipelines from S3 or CodeCommit, scoped roles included',
    published: '08.09.2026',
    services: [
      'codepipeline',
      'codecommit',
  ...
  stepfunctions: {
    ...
    description: 'Step Functions JSON & data flow',
    published: '14.09.2026',
    services: ['stepfunctions', 'lambda', 'rds', 'sqs', 'codebuild'],
  },
  'dead-mans-dashboard': {
    title: 'Dead Man’s Dashboard',
    description: 'The flying Watchman',
    published: '08.09.2026',
    services: ['cloudwatch'],
  },
  'cloud-init': {
    title: 'CLOUDINIT',
    description: 'Nix for Cloudsoydevs',
    published: '08.09.2026',
    services: ['ec2', 's3', 'iam', 'ecr', 'ecs', 'cli', 'iot', 'transfer', 'firehose'],
  },
  kubernetes: {
    title: 'Kubernetes Cheatsheet',
    description: 'The Big Beautiful EKS Cheatsheet',
    published: '08.09.2026',
    services: ['eks', 'iam', 'iot', 'transfer', 'glue', 'firehose'],
  },
  lambda: {
    title: 'Lambda Cheatsheet',
    description: 'Make Lambda Gandalf Again',
    published: '08.09.2026',
    services: [
      'lambda',
      'api-gateway',
  ...
  powertools: {
    title: 'Powertools',
    description: 'The secret 7th infinity stone',
    published: '08.09.2026',
    services: [
      'iam',
      'cli',
